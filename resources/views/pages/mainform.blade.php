    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="input-field col s12">
          <textarea id="textarea1" class="materialize-textarea validate inp3" required></textarea>
        ...
        <label for="style4">Ознакомился и <a href="#">принимаю условия публичной оферты</a>, а также соглашаюсь с обработкой персональных данных</label>
        </div>
      </div>
